class CheckoutController < ApplicationController
  def get_user
    ...
    @patron = {id: 2, event_id: 2, user_id: 1, swipe: "", checked_in: true, paddle_number: nil, table_number: nil, vip: nil, organization_member: nil, notes: nil, invited_by: nil, works_for: nil, other_identifier: nil, marketing_opt_out: nil}
